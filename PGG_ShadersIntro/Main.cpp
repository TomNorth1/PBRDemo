...
int main(int argc, char *argv[])
{
	...
	while( go )
	{
		...
		if (cmdRotateLeft & !cmdRotateRight)
		{
			...
			sceneTwo.ChangeCameraAngleY(1.0f * deltaTs);
		}
		...
		if (cmdRotateUp & !cmdRotateDown)
		{
			...
			sceneTwo.ChangeCameraAngleX(1.0f * deltaTs);
		}
		...
		if (showLightingWindow)
		{
			...
			ImGui::Checkbox("Show Comparison Scene", &isSceneTwo);
